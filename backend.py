...
class ImageSpec(BaseModel):
    ...
    alt: str
    caption: str
    prompt: str = Field(..., description="Prompt to send image model.")
...
builder.add_conditional_edges("router", route_condition, {"research": "research", "orchestrator": "orchestrator"})
